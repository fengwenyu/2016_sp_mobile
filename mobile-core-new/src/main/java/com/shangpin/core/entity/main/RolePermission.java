 ...
 * Filename:		com.shangpin.manager.entity.main.RolePermission.java
...
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE, region = "com.shangpin.core.entity.main.RolePermission")
public class RolePermission implements Idable<Long> {
    ...
    /**
     * @param rolePermissionDataControls
     *            the rolePermissionDataControls to set
     */
