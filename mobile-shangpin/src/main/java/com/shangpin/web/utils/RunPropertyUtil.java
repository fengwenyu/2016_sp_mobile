...
public class RunPropertyUtil {
	 public static final Logger logger = LoggerFactory.getLogger(RunPropertyUtil.class);

	    private static final String CHARSET = "UTF-8";

	    private static final String CONFIG_FILE_NAME = "config/run/count.properties";
