 ...
 * @version v1.0
 */
public class WeixinPropertyUtil {
    public static final Logger logger = LoggerFactory.getLogger(WeixinPropertyUtil.class);

    private static final String CHARSET = "UTF-8";

    private static final String CONFIG_FILE_NAME = "config/weixin/packet.properties";
