...
(function($) {
	...
	$(document).ready(function(){
		...
		$("body").append("<style>"+
								...
								".slotMachineGradient{"+
									"-webkit-mask-image: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(255,210,0,0)), color-stop(10%, rgba(255,210,0,1)), color-stop(90%, rgba(255,210,0,1)), color-stop(100%, rgba(255,210,0,0)) );"+
