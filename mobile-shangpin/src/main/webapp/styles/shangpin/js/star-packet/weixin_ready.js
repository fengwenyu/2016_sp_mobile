			...
			wx.onMenuShareAppMessage({
			    ...
			    success: function () { 
			    	...
			    	if($("#friend").length > 0){
				    	...
				    	//alert("phoneNum:" + phoneNum + ",batchNo:" + batchNo + ",amount:" + amount);
				    	window.location.href = "http://m.shangpin.com/star/had?batchNo=" + batchNo + "&phoneNum=" + phoneNum + "&amount=" + amount +"&source=1";
			    	}
			    },
			    cancel: function () { 
			        // 用户取消分享后执行的回调函数
