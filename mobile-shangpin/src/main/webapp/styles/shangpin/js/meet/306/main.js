$(document).ready(function(e) {
	...
	$('.venue_list li').click(function(e){
		e.preventDefault();
		var $that = $(this);
					...
					$.ajax({
						...
						success : function(data,textStatus, XMLHttpRequest) {
							...
							if (data == undefined) {
								...
								couponShowHtml = '<h3>领取成功</h3><p>礼券包已放入<em class="user_number">'+$.trim($("#J_mobileNum").val())+'账户,使用该账户登录APP，礼券包购物享优惠！</em></p><p></p><div class="step-btn"><a href="#" class="close_btn">确认</a></div>';
							}else{
    ...
    $("#passwordGetCode").click(function() {
        ...
        var counter = setInterval(function() {
            ...
            if(delay == 0) {
                ...
                $("#passwordGetCode").css('background','');
            }
        }, 1000);
    });
