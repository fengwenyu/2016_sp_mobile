...
<rapid:override name="custum">
	...
	<script type="text/javascript" charset="utf-8">
			loader = SP.core
				...
				.using("${cdn:js(pageContext.request)}/styles/shangpin/js/comment/productDetail.js${ver}")
				.using("${cdn:js(pageContext.request)}/styles/shangpin/js/comment/commonProductDetail.js${ver}")
	</script>
