...
<form id="orderForm" action="${ctx }/overseas/order/submit"  method="post" >
	...
	<input  type="hidden"  id="addressId"  name="addressId" value='<c:if test="${defAddress!=null }">${defAddress.id }</c:if>'/>
	...
	<input type="hidden"  id="buysIds" name="buysIds"  value="${fillData.list[0].buyId }" />
