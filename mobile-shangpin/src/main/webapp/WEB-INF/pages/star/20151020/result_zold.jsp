 ...
 <!--内容区域 start-->
  <section class="main main-box">  
    <div class="img-box bg-box">
        ...
        <div class="red-val">
          <!--<h3><i><img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/zly-1021/packet_icon.png" width="42" ></i>恭喜您获得了</h3>-->
          <img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/zly-1021/win_text01.png" />
           <c:if test="${amount ne '0'}">
          <h4 style="font-size:15px">您领到的是${amount }元现金和1020元礼包</h4>
          </c:if>
          <c:if test="${amount eq ''|| amount eq '0'}">
               <h4 style="font-size:15px">您领到的是1020元礼包</h4>
          </c:if>
