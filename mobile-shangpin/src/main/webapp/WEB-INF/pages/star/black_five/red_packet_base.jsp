...
<html lang="zh-CN">
	...
	<body style="background: url(${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/black_five/bg2.jpg) no-repeat top center; background-size:100% 100%;">
		<c:choose>
			<c:when test="${index}">
				<c:choose>
