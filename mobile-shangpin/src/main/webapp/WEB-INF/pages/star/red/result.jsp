...
<rapid:override name="content">
   ...
   <c:choose>
	<c:when test="${star eq '2' }">
      ...
      <%@ include file="/WEB-INF/pages/star/red/db_result_510info.jsp"%>
	</c:when>
	<c:otherwise>
      ...
      <%@ include file="/WEB-INF/pages/star/red/db_result_info.jsp"%>
	</c:otherwise>
   </c:choose>
...
<rapid:override name="static_file">
   <script src="${cdn:js(pageContext.request)}/styles/weixin/jweixin-1.0.0.js${ver}" type="text/javascript" charset="utf-8"></script>
    ...
    <script src="${cdn:js(pageContext.request)}/styles/shangpin/js/star-packet/swiper.min.js${ver}" type="text/javascript" charset="utf-8"></script>
