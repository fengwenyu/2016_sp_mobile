...
<div class="wapper1">
  ...
  <section class="main"> 
    <div class="red-val" style="position:relative;">
      ...
      <img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_48/receive_img01.png">
      <h3>恭喜您，90元礼券已放入</h3>
    ...
    <img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_48/receive_img02.png" >
    </a>
  </section>
  <!--内容区域 start-->
  <img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_48/img03.png" style="position:absolute; bottom:0;" >
 </div>
 <div id="popup_overlay"><img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_48/share.png" style="position: absolute; top:0; right:20px; width:65px; z-index:99999" ></div>
