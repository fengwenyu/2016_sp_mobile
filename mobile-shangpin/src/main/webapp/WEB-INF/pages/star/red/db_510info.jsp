...
<div class="wapper">
  ...
  <section class="main">
    <div class="red-title">
    	<img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_510/bg2.png" />
    </div>
    <div id="js_show_box">
    <div class="form-box">
  ...
  <!--内容区域 start-->
  <img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_510/img02.png"  >
