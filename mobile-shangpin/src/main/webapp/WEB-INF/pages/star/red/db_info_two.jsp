...
<div class="wapper">
  ...
  <section class="main">
    ...
    <div class="red-title">
    	<img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/db_1225/bg2.png" />
        <img style="position: absolute; top:40px; left:50%; -webkit-transform: translateX(-50%); transform: translateX(-50%); width:52%; z-index:99999" src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/db_1225/title.png" />
    </div>
    <div id="js_show_box" style="background:#99182b;">
    <div class="form-box">
    	<span class="icon1"><img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/db_1225/icon01.png" /></span>
        <span class="icon2"><img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/db_1225/icon02.png" /></span>
        <span class="icon3"><img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/db_1225/icon03.png" /></span>
        <span class="icon4"><img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/db_1225/icon04.png" /></span>
    ...
    <img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/db_1225/tip_text.png" >
  </section>
  <!--内容区域 start-->
