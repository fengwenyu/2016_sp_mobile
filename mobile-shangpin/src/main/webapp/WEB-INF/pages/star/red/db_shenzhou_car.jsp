...
<div class="wapper">
  ...
  <section class="main">
    ...
    <div class="red-title">
    	<img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_32/bg.jpg" />
        <img style="position: absolute; top:7%; left:30%; -webkit-transform: translateX(-50%); transform: translateX(-50%); width:50%; z-index:99999" src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_32/title.png" />
    </div>
    <div id="js_show_box" style="background:#eb4656;">
    <div class="form-box">
        <span class="icon2"><img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_32/icon02.png?1" /></span>
    ...
    <img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_32/tip_text.png" >
  </section>
  <!--内容区域 start-->
