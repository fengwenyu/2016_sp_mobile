...
<rapid:override name="content">
	...
	<section class="main">
	    ...
	    <div class="surprise">
	    	<h3><strong>惊喜一：</strong>恭喜你又获得一个红包</h3>
	        <div class="red-desc-box clr">
	        	<i><img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/red_icon1.png" ></i>
	            <p>红包已放入你尚品网账户  </p>
	            
	            <span class="coupon-img"><img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/star-packet/${amount}.png" ></span>
	        </div>
	    </div>
	    <div class="surprise">
