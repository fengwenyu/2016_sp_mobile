...
<%@ include file="/WEB-INF/pages/common/include.inc.jsp"%>
 ...
 <div class="product_info">
       ...
       <div class="content_info">
            ...
            <div class="content_size content_list" id="tabs_txt1" style="display:none">
               <section>
                ...
                <c:forEach var="pic" items="${productDetail.basic.allPics}">
                  <img src="${cdn:pic(pageContext.request)}/styles/shangpin/images/e.gif" lazy="${fn:replace(pic,'-10-10','-600-758')}">
                </c:forEach>
                </article>
              </section>
            </div> 
         ...
         <!--保养及售后start-->
         <div class="content_rand content_list nobottom border_bottom" id="tabs_txt4" style="display:none">
           ${productTemplate.html }
        </div>
        <!--保养及售后end-->
 </div>
