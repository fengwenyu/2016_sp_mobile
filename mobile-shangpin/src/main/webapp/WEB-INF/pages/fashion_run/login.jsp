...
<rapid:override name="content">   
  <div class="wrapper100">
      <form action="${ctx}/fashionrun/login" method="post" id="formSignIn" style="margin:0px">
            ...
            <div class="lgcontbjbar">
              <div class="lgcontbj2 l">
                <div class="lgcontbjcnt l">
                  ...
                  <h1 class="lgbtn lgmgtop02 l"><span><input type="image" src="${ctx}/styles/shangpin/images/FashionRun/loginqr.gif" ></span><span class="lgbtnmglt"><input type="image" src="${ctx}/styles/shangpin/images/FashionRun/loginqk.gif"  onclick="javascript:document.getElementById('formSignIn_UserName').value='';document.getElementById('formSignIn_Password').value='';return false;"></span></h1>
