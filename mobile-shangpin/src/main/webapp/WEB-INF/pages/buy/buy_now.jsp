...
<rapid:override name="content">
	<%@include file="/WEB-INF/pages/buy/order_detail.jsp" %>
	<%@include file="/WEB-INF/pages/buy/address_list.jsp" %>
	<%@include file="/WEB-INF/pages/buy/address_add.jsp" %>
	<%@include file="/WEB-INF/pages/buy/coupons.jsp" %>
	<%@include file="/WEB-INF/pages/buy/invoice.jsp" %>
</rapid:override>
