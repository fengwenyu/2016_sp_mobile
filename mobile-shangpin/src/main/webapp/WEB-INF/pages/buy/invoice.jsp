            ...
            <fieldset class="notBtm">
                ...
                <p>
                    ...
                    <select id="J_invoiceType" onchange="invoiceType();">
                        <c:choose>
                    		<c:when test="${buyNow.lastInvoiceFlag == '1' && buyNow.lastInvoiceType == '1'}">
                    			<option value="">请选择发票类型</option>
		                    	<option value="0" selected="selected">个人</option>
		                        <option value="1">公司</option>
                    		</c:when>
                    		<c:when test="${buyNow.lastInvoiceFlag == '1' && buyNow.lastInvoiceType == '2'}">
                    			<option value="">请选择发票类型</option>
                ...
                <p>
                    ...
                    <c:choose>
                    	<c:when test="${buyNow.lastInvoiceFlag == '1' }">
                    		<input type="text" id="J_invoiceName" name="invoiceName" value="${buyNow.lastInvoiceTitle}"/>
                    	</c:when>
                    	<c:otherwise>
