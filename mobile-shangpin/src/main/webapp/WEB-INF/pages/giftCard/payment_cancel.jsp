...
<div class="container">
    <div class="payment_block_o">
    	<i><img src="${cdn:css(pageContext.request)}/images/giftCard/detail/payment_cancel_icon.png" /></i>
        <h2>链接已失效，请联系发送人确认。</h2>
        <a href="${pageContext.request.contextPath}/login?back=/user/home"  class="submit_btn" id="payment_c_btn">登录</a>
    </div>
</div>
</rapid:override>
