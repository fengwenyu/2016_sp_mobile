        ...
        <div class="content_info">
          <div class="content_rand content_list rule-box">
              <section>
                ...
                <h3>多样化的主题，满足您不同的送礼需求</h3>
                <ul>
                	<li class="center_img"><img src="${cdn:js(pageContext.request)}/styles/shangpin/images/e.gif" lazy="${cdn:js(pageContext.request)}/styles/shangpin/images/giftcard/detail/e_giftcard03.png" /></li>
                    <li class="center_txt"><div><h6>祝福卡</h6><span>幸福永远跟随</span></div></li>
                </ul>
                <ul>
                    <li class="center_txt"><div><h6>结婚卡</h6><span>他和她一生的约定</span></div></li>
                	<li class="center_img"><img src="${cdn:js(pageContext.request)}/styles/shangpin/images/e.gif" lazy="${cdn:js(pageContext.request)}/styles/shangpin/images/giftcard/detail/e_giftcard04.png" /></li>
                </ul>
                <ul>
                	<li class="center_img"><img src="${cdn:js(pageContext.request)}/styles/shangpin/images/e.gif" lazy="${cdn:js(pageContext.request)}/styles/shangpin/images/giftcard/detail/e_giftcard05.png" /></li>
                    <li class="center_txt"><div><h6>感谢卡</h6><span>那些日子幸好有你</span></div></li>
                </ul>
                <ul>
                    <li class="center_txt"><div><h6>情人卡</h6><span>很幸运有你相伴</span></div></li>
                	<li class="center_img"><img src="${cdn:js(pageContext.request)}/styles/shangpin/images/e.gif" lazy="${cdn:js(pageContext.request)}/styles/shangpin/images/giftcard/detail/e_giftcard06.png" /></li>
                </ul>
                <ul>
                	<li class="center_img"><img src="${cdn:js(pageContext.request)}/styles/shangpin/images/e.gif" lazy="${cdn:js(pageContext.request)}/styles/shangpin/images/giftcard/detail/e_giftcard07.png" /></li>
                    <li class="center_txt"><div><h6>生日卡</h6><span>今天是属于你的日子</span></div></li>
                </ul>
                
                <!--<h3>多种发送祝福方式，根据“TA”的习惯个性化定制</h3>
                <article><p>购买成功后将礼品卡通过微信、短信发送给您的“TA”</p></article>
                <article><p>微信送祝福</p></article>
                <p class="center_txt">
                	<img src="${cdn:js(pageContext.request)}/styles/shangpin/images/e.gif" lazy="/images/giftcard/detail/e_giftcard08.png" />
                </p>
                <article><p>短信送祝福</p></article>
                <p class="center_txt">
                	<img src="${cdn:js(pageContext.request)}/styles/shangpin/images/e.gif" lazy="/images/giftcard/detail/e_giftcard09.png" />
                </p>-->
