...
<rapid:override name="content">
     <div class="step-box">
        ...
        <p class="warn-text"><i><img src="${cdn:js(pageContext.request)}/styles/shangpin/images/giftcard/detail/warn_icon.png" /></i>完成充值后，会有5分钟的延时，请您耐心等待</p>
         <form id="recharge_entityFrom" action="entityRecharge" method="post">
       	 	<input class="tip-input" id="cardno"  name="cardno" type="text" value="" placeholder="请输入卡号" required />
       	 	<input class="tip-input" id="passwd"  name="passwd" type="text" value="" placeholder="请输入卡密" required />
         </form>
        <input type="hidden" name="msg" id="msg" value="${msg }" />
        <div class="step-btn"><a href="javascript:;" id="rechargeEntity">确定</a></div>
    </div>
</rapid:override>
