...
public class Header implements Serializable {
	...
	public Header(String imei, String os, String osv, String productNum, String channelNum, String ver, String apn, String wh, String mt, String model, String operator, String ua) {
		super();
		this.imei = imei;
		this.os = os;
		this.osv = osv;
	...
	public String toString() {
		...
		json.put("os", os);
		json.put("osv", osv);
		json.put("productNum", productNum);
