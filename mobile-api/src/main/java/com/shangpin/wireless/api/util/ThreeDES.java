...
public class ThreeDES {
	...
	public static void main(String[] args) throws Exception {
		String szSrc = "oFHXijhanQsN1n6iZPyepw1fsmZ0|orderaction!orderlist";
//		System.out.println(encryptToString(szSrc));
		String encrypt = "+vxNxWFmwSabBiRFWRYaB9fqW9aBd17wIsxixE1XTh+X3bGTNRCW7uNYZVdiDqRG4xWmnvUUtPg=";
//		System.out.println(decryptToString(encrypt));
	}
}