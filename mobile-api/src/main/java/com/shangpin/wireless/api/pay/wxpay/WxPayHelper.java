...
public class WxPayHelper {
	...
	public String GetDeliverSign(HashMap<String, String> bizObj) throws SDKRuntimeException {
		HashMap<String, String> bizParameters = new HashMap<String, String>();
	...
	public JSONObject CreateBizjsPackage() throws SDKRuntimeException {
		HashMap<String, String> nativeObj = new HashMap<String, String>();
		if (CheckCftParameters() == false) {
			throw new SDKRuntimeException("生成package参数缺失！");
		}
		...
		nativeObj.put("paySign", GetBizSign(nativeObj));
		nativeObj.put("signType", SignType);
		String orderid=GetParameter("out_trade_no");
		long now = System.currentTimeMillis();

		return JSONObject.fromObject(nativeObj);

	}
	
	public JSONObject CreateBizjsDDeliverSign() throws SDKRuntimeException {
		HashMap<String, String> nativeObj = new HashMap<String, String>();
		if (CheckCftParameters() == false) {
			throw new SDKRuntimeException("生成package参数缺失！");
		}
