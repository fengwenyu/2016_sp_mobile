...
<title>${title }</title>
<link href="${cdn:css(pageContext.request)}/css/base.css?20121023001" rel="stylesheet" />
<link href="${cdn:css(pageContext.request)}/css/page/20150520/20150520formal.css" rel="stylesheet" />
<!-- icon -->
...
<script type="text/javascript" charset="utf-8">
  var ver = "?20121023001";
    loader = SP.core
      ...
      .excute()
      .using("${cdn:css(pageContext.request)}/js/20150520/20150520formal.js" + ver);
</script>
</head>
<body>
