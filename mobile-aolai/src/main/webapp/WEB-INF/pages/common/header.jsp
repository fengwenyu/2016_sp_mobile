...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F4a1503e1b896414af397f5a070a0bb86' type='text/javascript'%3E%3C/script%3E"));
</script>
...
<%
	_HMT _hmt = new _HMT("4a1503e1b896414af397f5a070a0bb86");
...
<header>
  ...
  <nav class="alUser_icon">
   <ul>
    <li><a href="<%=path%>/allcartaction!listCart"><img src="<%=path%>/images/cart_icon.png" width="31" height="31" alt="购物袋"></a></li>
    <li><a href="<%=path%>/orderaction!orderlist"><img src="<%=path%>/images/order_icon.png" width="31" height="31" alt="订单"></a></li>
    <li><a href="<%=path%>/accountaction!info"><img src="<%=path%>/images/user_icon.png" width="31" height="31" alt="账户"></a></li>
   </ul>
  </nav>
</header>
 <% }%>