...
<div class="alContent">
  ...
  <div class="alOrder_success">
    ...
    <a href="<%=path%>/orderaction!payment?orderid=${orderid}&amount=${amount}"  class="alOrder_buyBtn">继续支付</a>
     <a href="<%=path%>/orderaction!orderlist"  class="alOrder_buyBtn">查看订单</a>
  </div>
