...
public class SettlementServerOrderVO implements Serializable{

    /**
     * 
     */
    private static final long serialVersionUID = 5365701172173452187L;
    private String code;
    private String msg;
	...
	public  SettlementServerOrderVO jsonObj(String json) {
        ...
        if ("0".equals(code)) {
            ...
            if(listStr!=null){         
                productAllCartVO=new ProductServerAllCartVO().jsonObj2(listStr,"2").getProductAllCartVO();
