...
public class UserInterceptor extends HandlerInterceptorAdapter {
	...
	private boolean checkApp(String origin) {
		if (!StringUtils.isEmpty(origin) && "app".equals(origin)) {
			return true;
		}
		return false;
	}
	...
	private String appRedirectUrl(String paramsStr, String callbackUrl) {
		StringBuilder url = new StringBuilder();
		...
		url.append("=");
		url.append(Constants.AOLAI_URL);
		url.append(callbackUrl.replaceAll("%26", "8uuuuu8"));
		String redirectUrl = url.toString();
		logger.info("Else AppAuthAspect 1 callbackUrl={},redirectUrl={} ", callbackUrl.replaceAll("%26", "8uuuuu8"), redirectUrl);
		return redirectUrl;
	}
