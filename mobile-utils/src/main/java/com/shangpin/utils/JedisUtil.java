...
public class JedisUtil {
     ...
     * 底层支持集群的Jedis
     */
    private static ShangpinJedis shangpinJedis;
	...
	private final int expire = GlobalConstants.REDIS_EXPIRE_TIME;
	/*
	private static JedisPool jedisPool = null;
	
	private static int REDIS_MAX_TOTAL = GlobalConstants.REDIS_MAX_TOTAL;
	
	private static int REDIS_MAX_IDLE = GlobalConstants.REDIS_MAX_IDLE;
	
	private static int REDIS_MAX_WAIT_MILLIS = GlobalConstants.REDIS_MAX_WAIT_MILLIS;
	
	private static boolean REDIS_TEST_ON_BORROW = GlobalConstants.REDIS_TEST_ON_BORROW;
	
	private static boolean REDIS_TEST_ON_RETURN = GlobalConstants.REDIS_TEST_ON_RETURN;
	
	private static String REDIS_HOST = GlobalConstants.REDIS_HOST;
	
	private static int REDIS_PORT = GlobalConstants.REDIS_PORT;
	*/
	 ...
	 * 应用唯一标识主键
	 */
	private static final String APPLICATION_ID = "api";
	/**
	 * 该应用下的集群编号主键
	 */
	...
	static {/*
		...
		// redis如果设置了密码：
		// jedisPool = new JedisPool(config, GlobalConstants.REDIS_HOST,
		// GlobalConstants.REDIS_PORT, GlobalConstants.REDIS_DEFAULT_TIME_OUT,
		// GlobalConstants.REDIS_PASSWORD);
		// redis未设置了密码：*/
		shangpinJedis = new ShangpinJedis(APPLICATION_ID, CLUSTER_ID);
	...
	public String set(String key, String value) {
		return new Strings().set(key, value);
	}
	...
	public static void main(String[] args) {
		//long count = JedisUtil.getInstance().incr("page_count");
		//long count = JedisUtil.getInstance().decr("page_count");
		//System.out.println(count);
		System.out.println(JedisUtil.getInstance().new Sets().sadd("stu", "xiaolinag"));
	}
}
