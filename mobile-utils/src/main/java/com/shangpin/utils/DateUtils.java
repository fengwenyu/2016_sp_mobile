...
public class DateUtils {
    ...
    public static String getDateStr(String longDate) {
        if (longDate == null) {
            return null;
        }
        ...
        try {
            String str = sdf.format(Long.valueOf(longDate)).toString();
            return str;
        } catch (Exception e) {
            return null;
        }
    ...
    public static String getDateStr(Long longDate, String pattern) {
    	if (longDate == null) {
    		return null;
    	}
    	SimpleDateFormat sdf = new SimpleDateFormat(pattern);
     ...
     * @return 、String
     */
    public static String getDateFromDateTime(Timestamp dateTime, String type) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        return sdf.format(dateTime).toString();
    }

    /**
     * 从指定Timestamp中得到相应的日期的字符串形式 日期"XXXX-XX-XX XX:XX:XX"
     * 
     * @param dateTime
     * @return 、String
     */
    public static Date getDateFromCurrent(Long current) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date date = null;
        try {
            date = sdf.parse(sdf.format(current).toString());
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return date;
    ...
    public static String getDateStringFromLong(Long current) {
        DateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date date = new Date(current.longValue() * 1000L);
        return sdf.format(date);
    }

    public static Date getDateFromLong(Long current) {
        return new Date(current.longValue() * 1000L);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getDateStr(str));
    }
