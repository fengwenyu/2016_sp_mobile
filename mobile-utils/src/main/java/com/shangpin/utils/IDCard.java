...
public class IDCard {
	 ...
	 * @return
	 */
	public static boolean checkIDCard(String carID) {
		try {
			String errorInfo =IDCardValidate(carID);
			if(("").equals(errorInfo)){
				return true;
			}
	...
	public static void main(String[] args) throws ParseException {
		String IDCardNum = "51110219880102202X";
		...
		System.out.println(checkIDCard(IDCardNum));
	}
	/*********************************** 身份证验证结束 ****************************************/
