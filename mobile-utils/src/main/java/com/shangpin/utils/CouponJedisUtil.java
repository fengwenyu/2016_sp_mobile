...
public class CouponJedisUtil {

    public static Logger logger = LoggerFactory.getLogger(CouponJedisUtil.class);

    private static final CouponJedisUtil jedisUtil = new CouponJedisUtil();
    ...
    private static int REDIS_MAX_TOTAL = GlobalConstants.COUPON_REDIS_MAX_TOTAL;

    private static int REDIS_MAX_IDLE = GlobalConstants.COUPON_REDIS_MAX_IDLE;

    private static int REDIS_MAX_WAIT_MILLIS = GlobalConstants.COUPON_REDIS_MAX_WAIT_MILLIS;

    private static boolean REDIS_TEST_ON_BORROW = GlobalConstants.COUPON_REDIS_TEST_ON_BORROW;

    private static boolean REDIS_TEST_ON_RETURN = GlobalConstants.COUPON_REDIS_TEST_ON_RETURN;

    private static String REDIS_HOST = GlobalConstants.COUPON_REDIS_HOST;

    private static int REDIS_PORT = GlobalConstants.COUPON_REDIS_PORT;
    */
    /**
     * 私有化构造器
     */
    private CouponJedisUtil() {}
	/**
	 * 底层支持集群的Jedis
	 */
     ...
     * @return
     */
    public static CouponJedisUtil getInstance() {
        return jedisUtil;
    }
