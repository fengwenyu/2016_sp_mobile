...
public class ServiceJedisUtil {

    public static Logger logger = LoggerFactory.getLogger(ServiceJedisUtil.class);

    private static final ServiceJedisUtil jedisUtil = new ServiceJedisUtil();
    ...
    private static int REDIS_MAX_TOTAL = GlobalConstants.SERVICE_REDIS_MAX_TOTAL;

    private static int REDIS_MAX_IDLE = GlobalConstants.SERVICE_REDIS_MAX_IDLE;

    private static int REDIS_MAX_WAIT_MILLIS = GlobalConstants.SERVICE_REDIS_MAX_WAIT_MILLIS;

    private static boolean REDIS_TEST_ON_BORROW = GlobalConstants.SERVICE_REDIS_TEST_ON_BORROW;

    private static boolean REDIS_TEST_ON_RETURN = GlobalConstants.SERVICE_REDIS_TEST_ON_RETURN;

    private static String REDIS_HOST = GlobalConstants.SERVICE_REDIS_HOST;

    private static int REDIS_PORT = GlobalConstants.SERVICE_REDIS_PORT;*/
    /**
     * 构造器私有化
     */
    private ServiceJedisUtil() {}
    /**
	 * 底层支持集群的Jedis
	 */
     ...
     * @return
     */
    public static ServiceJedisUtil getInstance() {
        return jedisUtil;
    }
