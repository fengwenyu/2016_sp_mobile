...
public class Trade extends HttpServlet {
	...
	String basePath = "http://m.shangpin.com";
	//String basePath = "http://192.168.7.238:8080/MobileShangPin";
	//TODO add by zhouyu 支付宝回调地址修改为线上外网环境
	//String callbackUrl = "http://192.168.7.238:8080/MobileShangPin/alipay/callBack";
...
//		String subpaymode = request.getParameter("subpaymode");
		...
		// 记录访问日志
		FileUtil.addLog(request, "alipay/trade",// 
				channelNo,//  
				"userid", userid,//
				"orderid", orderId,
...
//		}
	 ...
	 * @throws IOException 
	 */
	private Map<String, String> prepareTradeRequestParamsMap(HttpServletRequest request) throws IOException {
		...
		AccountVO user = WebUtil.getSessionUser();
		String totalFee = getTotalFee(user.getUserid(), orderId);
...
//		String outTradeNo = System.currentTimeMillis() + "";
		...
		String notifyUrl = "http://m.shangpin.com/alipay/notifyReceiver";
		//String notifyUrl = "http://192.168.7.238:8080/MobileShangPin/alipay/notifyReceiver";
		// 未完成支付，用户点击链接返回商户url
		String res="0";//是否成功标志位 0未成功，1成功
		String parmresult=res+"-"+orderId+"-"+totalFee;
		String merchantUrl = basePath+"/unionpayaction!result?parmresult="+parmresult;
		// req_data的内容
