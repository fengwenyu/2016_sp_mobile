...
public class WebTrade extends HttpServlet {
	...
	//TODO add by zhouyu 支付宝回调地址修改为线上外网环境
	String callbackUrl = "";
	String spCallBackUrl = "http://192.168.9.36:9999/mobileshangpin/alipay/spwebcallBack";
	String alCallbackUrl = "http://192.168.9.36:9999/mobileshangpin/alipay/alwebcallBack";
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		System.out.println("WebTrade shopType is :" + shopType);
