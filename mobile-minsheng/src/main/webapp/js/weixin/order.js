$(function(){
	...
	$(".fillNumber .cut").click(function(){		
		...
		if(prodNumVal>=1){
			$.ajax({
			    url:'allcartaction!updateCartCount',
			    ...
			    success:function(data){
			      if(data.code=='0'){
			    	  ...
			    	  if(resultData.code=='1'){
			    		  maxNumVal=$this.parent(".fillNumber").find(".numberVal").val(resultData.InventoryQuantity);
	...
	function goToIndex(){
		var size=$("dd").length;
		if(size==1){
			window.location.href="allcartaction!listCart";
		}
