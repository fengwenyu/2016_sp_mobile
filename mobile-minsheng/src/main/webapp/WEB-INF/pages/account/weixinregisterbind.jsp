...
<div class="alContent">
  <form name="sigin" id="J_RegForm" action="weixinaction!registerbind?ch=${ch }" method="post">
  
  <fieldset>
    <br><legend>绑定后，无需登录即可享受订单物流跟踪、优惠券管理等尚品会员专属服务。</legend>
   ...
   <!-- 
    ...
    <input type="submit" class="login_btn" value="注册，并与微信绑定" />
    <!--a href="javascript:;" class="login_btn">注 册</a
    <div align="right" style="margin:0 0 10px 0;"><a href="<%=path %>/weixinaction!ok?ch=${ch}" >已有账号，请登录&gt;</a></div>-->
  </fieldset>
  </form>
</div>
