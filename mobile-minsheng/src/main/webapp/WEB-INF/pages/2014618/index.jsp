...
<body>
   <div class="topFix">
    <section>
      <nav id="filter_box">
        <ul class="header_nav">
          <li class="hover"><a href="<%=path%>/activeaction!meetpage?id=38&type=index&p=0">首页</a></li>
  ...
  <div class="sp520_list">
    <p class="top_img"><img src="<%=path%>/images/e.gif" lazy="<%=path%>/images/2014618/top_bg.jpg" width="320" height="160" /></p>
  </div>
