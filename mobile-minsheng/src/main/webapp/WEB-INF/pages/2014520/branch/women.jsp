...
<div class="topFix">
	<nav id="filter_box">
	  <ul class="header_nav">
	    ...
	    <li class="hover"><a href="<%=path%>/activeaction!meetpage?z=0&type=women&p=2&id=28">女装会场</a></li>
	    ...
	    <li><a href="<%=path%>/activeaction!meetpage?z=0&type=aolai&p=7&id=28">尚品奥莱</a></li>
	  </ul>
	</nav>
</div>
   ${html }
