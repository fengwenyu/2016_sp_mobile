...
<title>
<s:if test="cmsTitle != null">
	${cmsTitle }
</s:if>
<s:else>
有爱，还不购？尚品520四周年庆，520个国际大牌低至1.52折，让你赚不停！
</s:else>
</title>
...
<nav id="filter_box">
  <ul class="header_nav">
      ...
      <li><a href="<%=path%>/activeaction!meetpage?type=shoe&p=3&id=${id}">鞋靴控</a></li>
   ...
   <div class="sp_top_list">
    <p>
      <img src="<%=path%>/images/2014520/banner02.jpg" width="320" height="202" />
    </p>
    <ul>
      <li class="w135_h170">
        <a href="<%=path%>/merchandiseaction!miaoshaSplist?cmsTitle=大牌尖货152元还不购？-尚品4周年庆秒杀超值购" target="_self"><img src="<%=path%>/images/2014520/bg01.jpg" width="135" height="170" /></a>
      </li>
      <li class="w170_h83">
        <a href="<%=path%>/actlotaction!lotteryIndex?activeId=20140512&cmsTitle=释放梦想500豪礼白送啦！-尚品4周年庆抽奖百分百" target="_self"><img src="<%=path%>/images/2014520/bg02.jpg" width="170" height="83" /></a>
      </li>
      <li class="w170_h83">
        <a href="<%=path%>/activeaction!meetPage?type=mobile&cmsTitle=570元手机专享即领即得！-尚品4周年庆手机专属惠" target="_self"><img src="<%=path%>/images/2014520/bg03.jpg" width="170" height="83" /></a>
      </li>
      <li class="w150_h83">
        <a href="<%=path%>/activeaction!meetPage?type=order&cmsTitle=又买又送520元齐嗨森！-尚品4周年庆下单赚好礼" target="_self"><img src="<%=path%>/images/2014520/bg04.jpg" width="150" height="83" /></a>
      </li>
      <li class="w150_h83">
        <a href="<%=path%>/activeaction!meetPage?type=sign&cmsTitle=报尚名来，520元根本停不下来！-尚品4周年庆注册享好礼" target="_self"><img src="<%=path%>/images/2014520/bg05.jpg" width="150" height="83" /></a>
      </li>
