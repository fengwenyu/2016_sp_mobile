...
<nav class="alNav">
  <ul>
    <li><a href="<%=path%>/aolaiindex!index?ch=${ch}">首页</a></li>
...
<div class="alContent">
  ...
  <div class="alOrder_success">
    <h2><img src="<%=path%>/images/fail.png" width="36" height="36">您的订单支付未成功</h2>
    <a href="<%=path%>/orderaction!payment?ch=${ch}&orderid=${orderid}&amount=${amount}"  class="alOrder_buyBtn">继续支付</a>
     <a href="<%=path%>/orderaction!orderlist?ch=${ch}"  class="alOrder_buyBtn">查看订单</a>
  </div>
  
  <ul class="alOrder_done">
    <li>订 单 号：${orderid}</li>
    <!-- 
    <li>应付金额：<em>&yen;${payamount}</em></li>-->
  </ul>
