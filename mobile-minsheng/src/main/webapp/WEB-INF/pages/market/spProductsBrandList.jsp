...
<script type="text/javascript" charset="utf-8">
	...
	function getMore(){
 		...
 		$.post("<%=basePath%>brandaction!getmore",{
...
/* 		 	 		if(data.merchandiseList[i].status==010000){
		 	 		...
		 	 		$a.append($img);
		 	 		$a.attr("href", "<%=path%>/merchandiseaction!spdetail?ch=${ch}&brandid=${bid}&gender=${gender}&istop=${istop}&categoryid=${categoryid}&categoryname=${categoryname}&childCategoryid=${childcategoryid}&childCategoryname=${childCategoryname}&topicid=${topicid}&activityName=${activityName}&productid="+data.merchandiseList[i].productid+"");
...
<nav class="alNav">
	<ul>
		...
		<li><s:if test="brandName.length()>20"><s:property value="brandName.substring(0,10)"/>...</s:if>
			<s:else>
...
<div class="alContent">
	...
	<section class="alBrand_list">
		<jsp:include page="../common/productList.jsp" flush="true"></jsp:include>
