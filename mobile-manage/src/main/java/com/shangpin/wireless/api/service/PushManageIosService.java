 ...
 */
public interface PushManageIosService {

	public final static String SERVICE_NAME = "com.shangpin.wireless.api.service.impl.PushManageIosServiceImpl";
	 ...
	 * @Return T
	 */
	PushManageIos getById(Long id) throws Exception;
