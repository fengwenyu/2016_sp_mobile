...
public class WechatCreateCardBaseInfo implements java.io.Serializable  {
	...
	private WechatCreateCardBaseInfoSku sku;
	
	private WechatCreateCardBaseInfoDateInfo date_info;
	...
	private Boolean bind_openid;//    否   bool  true  是否指定用户领取，填写true或false。默认为false。通常指定特殊用户群体投放卡券或防止刷券时选择指定用户领取。	private String bind_openid;//    否   bool  true  是否指定用户领取，填写true或false。默认为false。通常指定特殊用户群体投放卡券或防止刷券时选择指定用户领取。
	...
	public WechatCreateCardBaseInfoSku getSku() {
		return sku;
	}
	public void setSku(WechatCreateCardBaseInfoSku sku) {
		this.sku = sku;
	}
	public WechatCreateCardBaseInfoDateInfo getDate_info() {
		return date_info;
	}
	public void setDate_info(WechatCreateCardBaseInfoDateInfo date_info) {
