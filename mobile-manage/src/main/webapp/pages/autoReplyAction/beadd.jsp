            ...
            <span class="tab_navs_switch"></span>
                            ...
                            <div class="tab_navs_wrp">
                                <ul class="tab_navs js_tab_navs" style="margin-left:0;">
                                    ...
                                    <li class="tab_nav tab_text width4 <s:if test="autoReplyBeadd.replyList[0].type == 1">selected</s:if>" data-type="1" data-tab=".js_textArea" data-tooltip="文字">
                                        <a href="javascript:void(0);" onclick="return false;">&nbsp;<i class="icon_msg_sender"></i><span class="msg_tab_title">文字</span></a>
                                    </li>

                                    <li class="tab_nav tab_img width4 <s:if test="autoReplyBeadd.replyList[0].type == 2">selected</s:if>" data-type="2" data-tab=".js_imgArea" data-tooltip="图片">
                                        ...
                                        <div class="media_cover">
                                            <span class="create_access webuploader-container">
                                                <a class="add_gray_wrp webuploader-pick" id="msgSendImgUploadBt" data-type="2" href="javascript:;">
                                                    ...
                                                    <form id='formFile_0' name='formFile' method="post" action="${pageContext.request.contextPath}/autoReplyAction_uploadMaterial.action" target='frameFile'enctype="multipart/form-data">
                                                        <input type="file" name="image" accept="image/*" class="upload_file_btn">
                                                    </form>

                                                    <i class="icon36_common add_gray"></i> <strong>上传图片</strong> </a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="upload_box r align_right">
                                <span class="upload_area webuploader-container">
                                    <a id="js_imageupload879262300208211" class="btn btn_primary js_imageupload webuploader-pick" data-groupid="">本地上传
                                        ...
                                        <form id='formFile_1' name='formFile' method="post" action="IbeaconHandler.ashx" target='frameFile' enctype="multipart/form-data">
                                            <input type="file" name="image" accept="image/*" class="upload_file_btn">
                                        </form>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#js_del").click(function(){
            location.href = "${pageContext.request.contextPath}/autoReplyAction_beaddDel.action"
        })
        ...
        $("#js_save").click(function(){
            ...
            location.href = "${pageContext.request.contextPath}/autoReplyAction_beaddSave.action?reply="+reply;
        });
