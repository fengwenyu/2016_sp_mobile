...
<body>
		...
		<table cellspacing="0" cellpadding="0" class="TableStyle">
	        ...
	        <thead>
	            <tr align=center valign=middle id=TableTitle>
	                <td width="">用户总数</td>
	                <td width="">下单用户占用户总数比例</td>
	                <td width=""><font color="red"><b>查询时段</b></font>内独立用户数</td>
	            </tr>
	        </thead>
	        <!--显示数据列表-->
	...
	<div id="QueryArea">
		<s:form action="accountStatisticsAction_uniqueUsersQuery" id="channelInfo" method="post">
		...
		<img src="${pageContext.request.contextPath}/accountStatisticsAction_image.action?queryType=2&startDate=${startDate}&endDate=${endDate}&type=hour" alt="" />
		<s:if test="picFlag==1">
			<!-- 
			...
			<img src="${pageContext.request.contextPath}/orderStatisticsAction_image.action?startDate=2012-10-19&endDate=2012-10-30&type=hour" alt="" />
			 -->
			<img src="${pageContext.request.contextPath}/accountStatisticsAction_image.action?queryType=2&startDate=${startDate}&endDate=${endDate}&type=day" alt="" />
		</s:if>
		<s:else>
			<div id="MainArea">
			    <table cellspacing="0" cellpadding="0" class="TableStyle">
