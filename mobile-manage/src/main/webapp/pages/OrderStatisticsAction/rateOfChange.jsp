...
<body>
	<div id="Title_bar">
	    <div id="Title_bar_Head"> 
	        ...
	        <!--页面标题-->
	        <div id="Title">
	            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 订单变化率查询
	        </div>
	        <div id="Title_End"></div>
	    </div>
	</div>
	<div id="QueryArea">
		<s:form action="orderStatisticsAction_rateOfChange" id="rateOfChange" method="post">
			<div style="">
				<table border=0>
					<tr>
