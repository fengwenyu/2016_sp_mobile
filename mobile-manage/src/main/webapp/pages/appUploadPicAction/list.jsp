		...
		.datagrid(
				{
					...
					striped: true,
					collapsible:true,
					url : '${pageContext.request.contextPath }/appUploadPicAction_query.action',
					remoteSort: true,
					showFooter:true,
					singleSelect :true,
					...
					columns : [ [

					 {
							...
							align:'center',
							formatter:function(value){
								return '<a style="color:#4574a0; font-weight:bold;" href="appUploadPicAction_info.action?id='+ value + '">' + "编&nbsp;&nbsp;辑 " + '</a>&nbsp;&nbsp;<a style="color:#4574a0; font-weight:bold;"  href=javascript:remove("' + value + '");>' + "删&nbsp;&nbsp;除" + '</a>';}
						}
					] ],
					title : '列表',
					width : 850,
	...
	<table border=0 cellspacing=3 cellpadding=5>
				<tr>
					...
					<td><input type="image"
					 ...
					 <td><s:a action="appUploadPicAction_editUI"><img src="${pageContext.request.contextPath}/style/images/createNew.png" /></s:a></td>
				</tr>
			</table>
