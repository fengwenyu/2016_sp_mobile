...
<form method="post" action="${contextPath }/management/admin/app/channel/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
