...
<form method="post" action="${contextPath }/management/maintain/find/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	<div class="pageFormContent" layoutH="58">  
		...
		<p>
			<label>图片宽度</label>
			<input id="imgWidth" name="imgWidth" type="text"  class="validate[required,minSize[1],maxSize[100]] required"/> 
		</p>
		<p>
			<label>图片宽度</label>
			<input  id="imgHeight" name="imgHeight" type="text"  class="validate[required,minSize[1],maxSize[100]] required"/>
						
		</p>
	
		<p>
			<label>开始时间：</label>
			<input type="text" name="showStartTime" class="required date" dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true"  />
			<a class="inputDateButton" href="javascript:;">选择</a>
		</p>
		<p>
			<label>结束时间：</label>
			<input type="text" name="showEndTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true" />
			<a class="inputDateButton" href="javascript:;">选择</a>
		</p>
		...
		<input id="type" name="type" type="hidden" value="IMAGETEXT"/> 
		</div>		
	<div class="formBar">
		<ul>
